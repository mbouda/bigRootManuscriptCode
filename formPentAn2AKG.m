function A=formPentAn2AKG(c2,c3,c5,Cn,Cp,k12,k21,nL)

    a1=cat(1,c3(1)/(c2(2)*Cp(2))-c3(1)/c5(2),...
        (c5(2:end-2)./(c2(3:end-1).*Cp(3:end))-c5(2:end-2)./c5(3:end-1)),...
        -c5(end-1)/c3(end));
    an1=cat(1,-(c5(2)/c3(1)),...
        c5(3:end-1)./(c2(2:end-2).*Cn(1:end-2))-c5(3:end-1)./c5(2:end-2),...
        c3(end)./(c2(end-1).*Cn(end-1))-c3(end)./c5(end-1));
    a2=cat(1,c3(1)/(c2(3)*k12(2)*Cp(2)),...
        c5(2:end-2)./(c2(4:end).*k12(3:end).*Cp(3:end)));
